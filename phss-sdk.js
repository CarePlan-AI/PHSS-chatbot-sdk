...
`;function i(){let e=document.getElementById("webwhiz__msg-popup");e&&(e.classList.remove("webwhiz__msg-popup--show"),localStorage.setItem("webwhiz__popupRemoved",!0),setTimeout(()=>{e.remove()},350))}!function(e){if("loading"!==document.readyState){e();return}document.addEventListener("DOMContentLoaded",e)}(()=>{setTimeout(()=>{(function(){var i=document.createElement("iframe");let s=function(){let e=document.getElementById("__phssSdk__"),t=e.getAttribute("chatbotId")||e.getAttribute("data-chatbot-id");return t}();i.setAttribute("class","webwhiz-widget"),i.setAttribute("id","webwhiz-widget"),i.setAttribute("frameborder","0");let a=document.getElementById("__phssSdk__"),o=a.getAttribute("container")||a.getAttribute("data-container");if(o){let e=document.querySelector(o);e&&e.appendChild(i)}else{var w=document.createElement("style");w.innerText=t,document.head.appendChild(w),document.body.appendChild(i)}let n=function(){let e=document.getElementById("__phssSdk__"),t=e.getAttribute("baseUrl")||e.getAttribute("data-base-url");return t||"https://api.webwhiz.ai"}();i.setAttribute("src",e+"?kbId="+s+"&baseUrl="+n)})(),window.onmessage=function(e){let t=document.getElementById("webwhiz-widget"),s=document.getElementById("__phssSdk__"),a=s.getAttribute("container")||s.getAttribute("data-container");return function(e){if("webwhiz:widget_expand"===e.data)t.classList.add("wb-expand"),i();else if("webwhiz:widget_collapse"===e.data)setTimeout(()=>{t.classList.remove("wb-expand","wb-maximize")},350);else if("webwhiz:widget_maximize"===e.data)t.classList.add("wb-maximize");else if("webwhiz:widget_minimize"===e.data)t.classList.remove("wb-maximize");else if(e.data&&"webwhiz:widget_config"===e.data.messageType){let s=e.data.config||{};"left"===s.position&&t.classList.add("wb-align-left");let o=JSON.parse(localStorage.getItem("webwhiz__popupRemoved"));!o&&s.showAsPopup&&s.welcomeMessages&&s.welcomeMessages.length>0&&!a&&function(e){let t=e.welcomeMessages.map(e=>`<div class="webwhiz__msg-popup-item">${e}</div>`).join(""),s=`<button class="webwhiz__msg-popup-close-btn" id="webwhiz__msg-popup-close-btn">
